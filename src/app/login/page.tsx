    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ fontSize: '11px', letterSpacing: '0.15em', color: '#60a5fa', fontWeight: '600', marginBottom: '12px', textTransform: 'uppercase' as const }}>
            Yogashri Heavy Engineering
          </div>
          <h1 style={{ fontSize: '2.25rem', fontWeight: '700', color: '#fff', lineHeight: '1.15', margin: '0 0 16px' }}>
            YHEPL<br />ERP System
          </h1>
      ...
      <div style={{ flex: 1, background: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '2rem' }}>
            <form action={handleSubmit}>
              <div style={{ marginBottom: '1.125rem' }}>
                <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: '600', color: '#374151', marginBottom: '7px' }}>Email address</label>
                <input
                  name="email" type="email" required
                  defaultValue="harish@yhepl.in"
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'block', fontSize: '0.8125rem', fontWeight: '600', color: '#374151', marginBottom: '7px' }}>Password</label>
                <input
              ...
              <button
                type="submit"
                disabled={isPending}
                style={{ display: 'block', width: '100%', padding: '12px', fontSize: '0.9375rem', fontWeight: '600', color: '#fff', background: isPending ? '#93c5fd' : '#1e40af', border: 'none', borderRadius: '8px', cursor: isPending ? 'not-allowed' : 'pointer' }}
              >
          ...
          <p style={{ textAlign: 'center' as const, fontSize: '0.75rem', color: '#94a3b8', marginTop: '1.5rem' }}>
