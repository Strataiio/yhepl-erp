    ...
    <div style={{ minHeight:'100vh', display:'flex', fontFamily:'system-ui,sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ position:'relative', zIndex:1 }}>
          {/* Logo mark */}
          <div style={{
            width:'52px', height:'52px', background:'#1e40af', borderRadius:'12px',
          ...
          <div style={{ marginTop:'48px', display:'flex', flexDirection:'column', gap:'12px' }}>
            {['Project & Bucket Tracking', 'QC & Weld Management', 'HR & Payroll', 'Live Cost Ledger'].map(f => (
      ...
      <div style={{
        flex:1, background:'#f8fafc', display:'flex', alignItems:'center',
            ...
            <form onSubmit={handleLogin}>
              <div style={{ marginBottom:'1.125rem' }}>
                ...
                <input
                  ...
                  required placeholder="harish@yhepl.in"
                  style={{
              ...
              {error && (
                <div style={{ background:'#fef2f2', border:'1px solid #fecaca', borderRadius:'8px', padding:'10px 14px', marginBottom:'1rem' }}>
